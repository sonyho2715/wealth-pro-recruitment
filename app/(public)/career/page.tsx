  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/agent/login"
                className="text-slate-600 hover:text-slate-900 text-sm font-medium transition hidden sm:block"
              >
                Agent Login
              </Link>
              <Link
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="heading-display text-slate-900 mb-6">
            ...
            <span className="block text-gradient-premium">Advisory Career</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/prospect"
              className="bg-slate-900 text-white font-medium px-8 py-4 rounded-xl hover:bg-slate-800 transition inline-flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#benefits"
              className="border border-slate-200 text-slate-700 font-medium px-8 py-4 rounded-xl hover:bg-slate-50 transition inline-flex items-center justify-center gap-2"
            >
              Learn More
            </a>
          </div>
      ...
      <section className="py-20 px-4 bg-white border-y border-slate-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-serif text-slate-900 mb-4">How Our Process Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">1. Your Financial Review</h3>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">2. Agent Income Projection</h3>
              <p className="text-slate-600">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">3. Compare Your Futures</h3>
              <p className="text-slate-600">
          ...
          <div className="text-center mt-12">
            <Link
              href="/prospect"
              className="bg-slate-900 text-white font-medium px-8 py-4 rounded-xl hover:bg-slate-800 transition inline-flex items-center gap-2"
            >
              Start Your Analysis
              <ArrowRight className="w-5 h-5" />
            </Link>
      ...
      <section id="benefits" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-serif text-slate-900 mb-4">Why Become an Agent?</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 px-4 bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="heading-serif text-white mb-4">Income Potential</h2>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <div className="font-medium text-slate-300 mb-1">{tier.label}</div>
                <div className="text-sm text-slate-400">{tier.hours}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <ComplianceDisclaimer
              variant="income"
              className="bg-white/10 border-white/20 [&_p]:text-slate-300 [&_.text-amber-800]:text-slate-200 [&_.text-amber-700]:text-slate-300"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-serif text-slate-900 mb-4">Your Path to Success</h2>
            <p className="text-slate-600">A clear roadmap from day one to established agent</p>
          </div>
          ...
          <div className="relative">
            ...
            {timeline.map((step, index) => (
              <div key={index} className="relative flex items-start gap-6 mb-8">
                <div className="w-16 h-16 bg-slate-900 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0 z-10">
                  {index + 1}
                </div>
                <div className="bg-white border border-slate-200 rounded-2xl p-6 flex-1 shadow-sm">
                  <div className="text-sm text-slate-500 font-medium mb-1">{step.week}</div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="heading-serif text-slate-900 mb-4">Ready to See Your Potential?</h2>
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-xl font-semibold">Wealth Pro</span>
          </div>

          <ComplianceDisclaimer
            variant="full"
            className="bg-slate-800/50 text-slate-300 [&_h4]:text-slate-200 [&_strong]:text-slate-200 mb-8"
          />

          <p className="text-slate-500 text-sm text-center">
            &copy; {new Date().getFullYear()} Wealth Pro. All rights reserved. For informational purposes only.
          </p>
        </div>
      </footer>
    </div>
